...
import com.mresearch.shared.FieldVerifier;
...
import com.mresearch.shared.services.DatabankServicesAsync;

/**
 * Entry point classes define <code>onModuleLoad()</code>.
 */
public class databank implements EntryPoint {
  /**
  ...
  public void onModuleLoad() {
    ...
    RootPanel.get("localeInfoContainer").add(new Label(LocaleInfo.getCurrentLocale().getLocaleName()));
...
//          }
//        });
        databankService.getServiceName(new AsyncCallback<String>() {
          public void onFailure(Throwable caught) {
            // Show the RPC error message to the user
            dialogBox.setText("Remote Procedure Call - Failure");
            serverResponseLabel.addStyleName("serverResponseLabelError");
